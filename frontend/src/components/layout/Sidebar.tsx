...
import { Home, Map, BarChart3, Route, Settings, Car, Brain } from 'lucide-react';
...
export default function Sidebar() {
  return (
    <aside 
      ...
      style={{ backgroundColor: DARK_CARD, borderRight: `1px solid ${DARK_BORDER}` }}
    >
      {/* Logo Placeholder */}
      <div className="mb-8">
        <div 
        ...
        <div className="text-[8px] text-center mt-1 tracking-widest" style={{ color: DARK_TEXT_MUTED }}>
          PORSCHE
        </div>
      </div>
